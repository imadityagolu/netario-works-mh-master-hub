...
function JoinBoard() {
    ...
    <div className='text-center place-content-center items-center flex pb-8'>
      ...
      {/* header */}
      <div className='bg-linear-to-br from-yellow-500 to-yellow-100 rounded-2xl w-[85%] pt-12 pb-8 p-2'>

        <h1 className='lg:text-3xl md:text-3xl text-lg text-center'>Join ambitious professionals and <br></br>unlock your dream career today</h1>
